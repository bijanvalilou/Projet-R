...
```{r}
z <- c(Sc6[,"va_ind_2"],Sc6[,"va_trsp_2"],Sc6[,"va_ser_2"],Sc6[,"va_trsf_2"],Sc6[,"va_ele_2"])
x <- rep(Sc6[,"year"], times = 5)
...
ggplot(
  ...
  labs(x = "year", y = "Valeur ajoutée (en %)", title = "Valeur ajoutée par secteur -. Ecart par rapport au scénario de référence") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
...
## B. Identity Kaya au niveau aggrege

```{r}

ggplot() + 
  geom_line(aes(x = S2[,"year"],y = S2[,"ems_co2_2"]/Baseline[,"ems_co2_0"], group = 1, color = "Total effect"), size = 1.0) + 
  geom_line(aes(x = S2[,"year"],y = S2[,"va_2"]/Baseline[,"va_0"], group = 1, color = "E")) + 
  geom_line(aes(x = S2[,"year"],y = ((S2[,"ci_toe_2"]+S2[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S2[,"va_2"]/Baseline[,"va_0"]), group = 1, color = "I")) + 
  geom_line(aes(x = S2[,"year"],y =  (S2[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S2[,"ci_toe_2"]+S2[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])), group = 1, color = "P")) + 
  labs(x = "year", y = "Index of Kaya identity", title = "Kaya identity at aggragated level - Carbon Tax with redistribution") +
  scale_x_continuous(breaks=seq(2015,2050,5))
...
z <- c(log(S2[,"va_2"]/Baseline[,"va_0"])*(S2[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S2[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log(((S2[,"ci_toe_2"]+S2[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S2[,"va_2"]/Baseline[,"va_0"]))*(S2[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S2[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log((S2[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S2[,"ci_toe_2"]+S2[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])))*(S2[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S2[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"]))
       )
x <- rep(S2[,"year"], times = 3)
y <- rep(c("E","I","P"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'stack') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Variation of CO2 emission", title = "Kaya identity at aggragated level - Carbon Tax with redistribution") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
...
ggplot() + 
  ...
  geom_line(aes(x = S4[,"year"],y = S4[,"va_2"]/Baseline[,"va_0"], group = 1, color = "E")) + 
  geom_line(aes(x = S4[,"year"],y = ((S4[,"ci_toe_2"]+S4[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S4[,"va_2"]/Baseline[,"va_0"]), group = 1, color = "I")) + 
  geom_line(aes(x = S4[,"year"],y =  (S4[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S4[,"ci_toe_2"]+S4[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])), group = 1, color = "P")) + 
  labs(x = "year", y = "Index of Kaya identity", title = "Kaya identity at aggragated level - Energy subsidy with redistribution") +
  scale_x_continuous(breaks=seq(2015,2050,5))

```

```{r}
z <- c(log(S4[,"va_2"]/Baseline[,"va_0"])*(S4[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S4[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log(((S4[,"ci_toe_2"]+S4[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S4[,"va_2"]/Baseline[,"va_0"]))*(S4[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S4[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log((S4[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S4[,"ci_toe_2"]+S4[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])))*(S4[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S4[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"]))
       )
x <- rep(S2[,"year"], times = 3)
y <- rep(c("E","I","P"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'stack') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Variation of CO2 emission", title = "Kaya identity at aggragated level - Energy subsidy with redistribution") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
```
...
ggplot() + 
  geom_line(aes(x = S5[,"year"],y = S5[,"ems_co2_2"]/Baseline[,"ems_co2_0"], group = 1, color = "Total effect"), size = 1.0) + 
  geom_line(aes(x = S5[,"year"],y = S5[,"va_2"]/Baseline[,"va_0"], group = 1, color = "E")) + 
  geom_line(aes(x = S5[,"year"],y = ((S5[,"ci_toe_2"]+S5[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S5[,"va_2"]/Baseline[,"va_0"]), group = 1, color = "I")) + 
  geom_line(aes(x = S5[,"year"],y =  (S5[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S5[,"ci_toe_2"]+S5[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])), group = 1, color = "P")) + 
  labs(x = "year", y = "Index of Kaya identity", title = "Kaya identity at aggragated level - Renewable Energy ") +
  scale_x_continuous(breaks=seq(2015,2050,5))

```

```{r}
z <- c(log(S5[,"va_2"]/Baseline[,"va_0"])*(S5[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S5[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log(((S5[,"ci_toe_2"]+S5[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S5[,"va_2"]/Baseline[,"va_0"]))*(S5[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S5[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log((S5[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S5[,"ci_toe_2"]+S5[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])))*(S5[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S5[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"]))
       )
x <- rep(S2[,"year"], times = 3)
y <- rep(c("E","I","P"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'stack') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Variation of CO2 emission", title = "Kaya identity at aggragated level - Renewable Energy") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
```
...
ggplot() + 
  geom_line(aes(x = S6[,"year"],y = S6[,"ems_co2_2"]/Baseline[,"ems_co2_0"], group = 1, color = "Total effect"), size = 1.0) + 
  geom_line(aes(x = S6[,"year"],y = S6[,"va_2"]/Baseline[,"va_0"], group = 1, color = "E")) + 
  geom_line(aes(x = S6[,"year"],y = ((S6[,"ci_toe_2"]+S6[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S6[,"va_2"]/Baseline[,"va_0"]), group = 1, color = "I")) + 
  geom_line(aes(x = S6[,"year"],y =  (S6[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S6[,"ci_toe_2"]+S6[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])), group = 1, color = "P")) + 
  labs(x = "year", y = "Index of Kaya identity", title = "Kaya identity at aggragated level - SNBC ") +
  scale_x_continuous(breaks=seq(2015,2050,5))

```

```{r}
z <- c(log(S6[,"va_2"]/Baseline[,"va_0"])*(S6[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S6[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log(((S6[,"ci_toe_2"]+S6[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"]))/(S6[,"va_2"]/Baseline[,"va_0"]))*(S6[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S6[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"])),
       log((S6[,"ems_co2_2"]/Baseline[,"ems_co2_0"])/((S6[,"ci_toe_2"]+S6[,"ch_toe_2"])/(Baseline[,"ci_toe_0"]+Baseline[,"ch_toe_0"])))*(S6[,"ems_co2_2"]-Baseline[,"ems_co2_0"])/(log(S6[,"ems_co2_2"])-log(Baseline[,"ems_co2_0"]))
       )
x <- rep(S2[,"year"], times = 3)
y <- rep(c("E","I","P"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'stack') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Variation of CO2 emission", title = "Kaya identity at aggragated level - SNBC") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
```
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'fill') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Emploi (en %)", title = "Emploi par secteur - Scénario de référence") + 
  scale_x_continuous(breaks=seq(2015,2050,5))+
...
z <- c(Sc5[,"f_l_ind_2"],Sc5[,"f_l_trsp_2"],Sc5[,"f_l_ser_2"],Sc5[,"f_l_trsf_2"],Sc5[,"f_l_ele_2"])
x <- rep(S6[,"year"], times = 5)
y <- rep(c("Industrie et agriculture","Transports","Services","Transformation d'énergie","Electricité"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'stack') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Emploi (en %)", title = "Variation de l'emploi par secteur. Ecart par rapport au scénario de référence.") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
...
z <- c(S5[,"f_l_ind_2"],S5[,"f_l_trsp_2"],S5[,"f_l_ser_2"],S5[,"f_l_trsf_2"],S5[,"f_l_ele_2"])
x <- rep(S6[,"year"], times = 5)
y <- rep(c("Industrie et agriculture","Transports","Services","Transformation d'énergie","Electricité"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'fill') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Emploi (en %)", title = "Scénario ENR") + 
  scale_x_continuous(breaks=seq(2015,2050,5))+
  scale_y_continuous(breaks = brks,labels = scales::percent(brks))
...
stacked_data <- data.frame(
  ...
  percent = c(S4[,"ia_ind_2"],S4[,"ia_trsp_2"],S4[,"ia_ser_2"],S4[,"ia_trsf_2"],S4[,"ia_ele_2"]),
  sectors = factor(rep(sectors, each = 36), levels = rev(sectors))
)

stacked_labels <- data.frame(
  labels = c("Industry and agriculture","Transports","Services","Transformation of énergy","Electricity"),
...
data_S4_i <- S6[,"year"]
data_S4_i <- as.data.frame(data_S4_i)
data_S4_i <- cbind(data_S4_i,Sc4[,"ia_ind_2"],Sc4[,"ia_trsp_2"],Sc4[,"ia_ser_2"],Sc4[,"ia_trsf_2"],Sc4[,"ia_ele_2"])
colnames(data_S4_i) <- c("Year","Industry and agriculture","Transports","Services","Transformation of énergy","Electricity")

plt_S4_i <- ggplot(data_S4_i) +
  # color = "white" indicates the color of the lines between the areas
  geom_area(aes(data_S4_i$year, percent, fill = region), color = "white") +
...
z <- c(S4[,"ia_ind_2"],S4[,"ia_trsp_2"],S4[,"ia_ser_2"],S4[,"ia_trsf_2"],S4[,"ia_ele_2"])
x <- rep(S6[,"year"], times = 5)
y <- rep(c("Industrie et agriculture","Transports","Services","Transformation d'énergie","Electricité"), each = 36)
...
ggplot(
  ...
  geom_bar(stat = 'identity', position = 'fill') + guides(fill = guide_legend(reverse = TRUE)) + 
  labs(x = "year", y = "Investment (in %)", title = "Change in investment by sector in the scenario of energy subsidy removal with recycling. Deviation from the baseline scenario.") + 
  scale_x_continuous(breaks=seq(2015,2050,5))
