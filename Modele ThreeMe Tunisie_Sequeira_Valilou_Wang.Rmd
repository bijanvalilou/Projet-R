...
kable(Table_Macro_CT, booktabs = T, linesep = "", caption = "Macroeconomic impacts of Lifting energy subsidies scenario with redistribution in percent deviation to Baseline") %>% 
kable_styling(latex_options = "striped", full_width = T,font_size = 7) %>% 
row_spec(0, bold = T)  %>% 
column_spec(1, width = "6cm")
```
