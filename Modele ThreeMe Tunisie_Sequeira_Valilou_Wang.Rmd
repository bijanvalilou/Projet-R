...
ThreeME combines several features as pointed out @callonnec2013 :

-   ThreeME is a Computable General Equilibrium Model (CGEM).

![](Images/Architecture%20of%20a%20CGEM.jpg){Fig.X .: .Architecture .of .a .CGEM=""}

-   The high sectoral disaggregation is a way to describe the transfers of activity from a sector to another. The ThreeME model allows to track changes in investment, employment or energy consumption.
