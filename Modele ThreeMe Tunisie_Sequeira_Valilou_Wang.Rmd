...
Implementation of a carbon tax (from 2021) without recycling of the revenues of this tax in the economy. They are used to reduce public debt
Carbon tax with recycling: recycling in the GTF (Energy Transition Fund): in fact:
Part is given back to households (they are given back what they paid)
A portion to “non-polluting” businesses (I’ll give you the exact allocation rule by sector later)
Removal of subsidies on fossil fuels (without recycling)
Fossil fuel subsidies lifted (with recycling)
Part is given back to households (they are given back what they paid)
A share of enterprises in proportion to the employment of each sector in the total salaried labour force
A significant penetration of ENR in the electrical mix is required (80% by 2050)
Package 2-4-5. 
