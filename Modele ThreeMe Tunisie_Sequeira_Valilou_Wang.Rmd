...
ggplot() + 
  ...
  labs(x = "year", y = "Price \n in % deviation to Baseline", title = "Fig.17 Evolution of prices on Tunisia's market with regard to baseline scenario") + 
    theme(axis.title=element_text(size=9),title = element_text(size=9), plot.title = element_text(hjust = 0.5, vjust = 0.5)) +
  scale_x_continuous(breaks=seq(2015,2050,5))
...
ggplot() + 
  ...
  labs(x = "year", y = "Index LMDI \nin % deviation of emission to Baseline", title = "Fig.36 Multiplicative contribution for overall emissions variation by different sectors \n Renewable Energy") +
    theme(axis.title=element_text(size=9),title = element_text(size=9), plot.title = element_text(hjust = 0.5, vjust = 0.5)) +
  scale_x_continuous(breaks=seq(2015,2050,5))
...
ggplot() + 
  ...
  labs(x = "year", y = "Index LMDI \nin % deviation of emission to Baseline", title = "Fig.38 Additive contribution of economy structure for overall emissions variation \n Renewable Energy") + 
    theme(axis.title=element_text(size=9),title = element_text(size=9), plot.title = element_text(hjust = 0.5, vjust = 0.5)) +
  scale_x_continuous(breaks=seq(2015,2050,5))
