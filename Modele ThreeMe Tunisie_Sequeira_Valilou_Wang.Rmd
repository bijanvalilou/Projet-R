...
After set-backs over the past two-decades, carbon pricing has become popular once again. Since 2016, eight new carbon-pricing initiatives have been implemented, with dozens of additional countries having pledged under the Paris Agreement to consider implementing carbon pricing in the years ahead.

@goulder2013

When considering the externality associated with the release of CO2 from combustion, we observe that there is a maginal social cost that exceeds marginal private cost by an amount reflecting the marginal external cost of damage. The typical prescription is to put a tax on emissions that reflects the marginal external damage. In a competitive market this will cause private costs to rise.
...
The level of the price retained, in other words the rate of the tax, corresponds to the value that society places on the protection of these resources.
