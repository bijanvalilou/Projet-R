...
![](C:/Users/Lucia/AppData/Local/RStudio/tmp/paste-5C9E93C5.png)
...
As we saw in the section "Importance of redistribution", the energy subsidies removal has a positive impact on households' disposable income, which is small in the short and medium term. In the long term, income increases by 0.68% in 2050 compared to the reference scenario. A linear regression confirms the existence of a positive income elasticity, but weak compared to the price elasticity. We therefore neglect the income elasticity of energy demand.
...
kbl(table, booktabs = T, linesep = "", caption = "Price elasticity of demand for fuel dedicated to other use")%>%
